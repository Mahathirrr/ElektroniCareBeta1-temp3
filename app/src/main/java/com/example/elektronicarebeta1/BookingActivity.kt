...
import com.example.elektronicarebeta1.viewmodels.RepairRequestsState
...
class BookingActivity : AppCompatActivity() {
    ...
    private fun updateImagePreviews(images: List<Uri>) {
        ...
        images.forEach { uri ->
            ...
            Glide.with(this)
                .load(uri)
                .into(imageView.findViewById(R.id.previewImage))
    ...
    private fun createWhatsAppIntent(): Intent {
        ...
        return Intent(Intent.ACTION_VIEW).apply {
            data = Uri.parse("https://wa.me/${getString(R.string.service_whatsapp)}?text=${Uri.encode(message)}")
        }
    }
}
```